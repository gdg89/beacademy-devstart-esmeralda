<header class="text-white body-font bg-emerald-500 sticky top-0 z-50">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a href="@if(Route::currentRouteName() === 'home') # @else / @endif"
            class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-emerald-500 p-2 bg-white rounded-full"
